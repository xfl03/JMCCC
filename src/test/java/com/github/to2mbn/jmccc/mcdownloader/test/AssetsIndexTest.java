...
import com.github.to2mbn.jmccc.mcdownloader.AssetsIndex;
...
public class AssetsIndexTest {
	...
	public void testFromJson() {
		...
		AssetsIndex indexAc = AssetsIndex.fromJson(new JSONObject(json));
		...
		assertEquals(new AssetsIndex(assetsEx), indexAc);
		assertEquals(assetsEx, indexAc.getAssets());
	}
